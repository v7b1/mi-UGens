...
static const float kLP2Gain = -100e3f / 39e3f * 0.1f;   // vb: factor in down scaling to -1/+1 range
static const float kLP4Gain = -100e3f / 33e3f * 0.1f;
static const float kBP2Gain = -100e3f / 39e3f * 0.1f;
...
public:
    ...
    void process(Frame& frame)
    {
        ...
        v_oct += frame.freq_cv;
        //v_oct += frame.fm_cv * frame.fm_knob; // vb, we don't need it
